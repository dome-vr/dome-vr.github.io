...
const config:Config = {
    ...
    // NOTE: _three not currently used
    // THREE is loaded as global with addr as flollows:
    //_three: './utils/three.js/build/three.js',
    // r86
    _stats: './utils/three.js/examples/js/libs/stats.min',
    // r93,...
    //_stats: './utils/three.js/examples/libs/stats.min',
...
//                fsh:'./app/models/space/quad_fsh/fsh_rm_expt.glsl'      
//               }
//      }
////    },
//      }
