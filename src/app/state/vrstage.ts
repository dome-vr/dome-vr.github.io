    ...
    async.parallel({
      frame: function(callback){
        try{
          ...
          mediator.loge(`vrstage.delta caused error: ${e}`);
          callback(null, {});
        }
      },
      ...
      (err, o) => {
        ...
        mediator.log(`vrstage: o['environemt']['axes'] = ${o['environment']['axes']}`);
        mediator.log(`vrstage: o['environemt']['ambient_light'] = ${o['environment']['ambient_light']}`);
        mediator.log(`vrstage: o['environemt']['fog'] = ${o['environment']['fog']}`);
        mediator.log(`vrstage: o['skycube']['skycube'] = ${o['skycube']['skycube']}`);
        mediator.log(`vrstage: o['skydome']['skydome'] = ${o['skydome']['skydome']}`);
        callback(null, {
