...
#define TUNNEL_RADIUS 1.95   // > 1.25 → bigger tunnels → thinner beams
#endif
#ifndef TUNNEL_TAPER
#define TUNNEL_TAPER 0.80   // 0..1, tunnels widen higher up
#endif
#ifndef ANISO_YZ
#define ANISO_YZ 0.60   // YZ squeeze (nave ribs)
#endif
#ifndef ANISO_XZ
#define ANISO_XZ 0.60   // XZ squeeze (transept ribs)
#endif
#ifndef ANISO_XY
#define ANISO_XY 0.88   // XY squeeze (vertical feel)
#endif
#ifndef DILATE_FIELD
#define DILATE_FIELD 0.00   // subtract from SDF → dilate tunnels globally
#endif
...
// REPLACED: Use proper sky system instead of hardcoded colors
...
// REPLACED: Use proper sky system
...
void main(){
  ...
  if (hit){
    ...
    // REPLACED: Use proper sky system instead of hardcoded cube
    col = skyColor(rd);
  }
