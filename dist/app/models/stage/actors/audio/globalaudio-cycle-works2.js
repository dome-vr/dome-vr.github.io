...
export const Globalaudio = class {
    static create(options = {}, narrative) {
        ...
        return new Promise((resolve, reject) => {
            ...
            playbackRate = options['playbackRate'] || 1.0, volume = options['volume'] || 1.0, play = false, pause = false, stop = true, audioLoader = new THREE.AudioLoader(), sound = new THREE.Audio(narrative['audioListener']);
...
//# sourceMappingURL=globalaudio-cycle-works2.js.map