...
const uniforms = {
    ...
    uFwd: { type: 'v3', value: new THREE.Vector3(0., 0., -1.) },
...
const fsh = `
     ...
     //uniform vec3 uEye;          // initial rm-ray origin
     uniform float uEyeX;          // initial rm-ray origin
     uniform float uEyeY;          // initial rm-ray origin
     uniform float uEyeZ;          // initial rm-ray origin
...
vec4 colormarch(vec3 ro, vec3 rd) {
   ...
   return vec4(0.0,0.0,0.0,1.0);
     ...
     void main() {
       ...
       //feb18_2024 expt
       vec3 eye = vec3(uEyeX,uEyeY,uEyeZ);    //initially (0,0,1000)
...
export { fsh, uniforms };
//# sourceMappingURL=fsh_rmanimkeymapcantor_vrskybox.glsl.js.map
