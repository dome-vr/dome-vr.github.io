...
const fsh = `
     ...
     uniform float uEyeX;         //initial x-component of rm-ray-origin
     uniform float uEyeY;         //initial y-component of rm-ray-origin
     uniform float uEyeZ;         //initial z-component of rm-ray-origin
...
//        uniforms:_uniforms};
export { fsh, uniforms };
//# sourceMappingURL=fsh_rm_expt1.glsl.js.map
