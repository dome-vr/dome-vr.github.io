...
const uniforms = {
    uEyeX: { type: 'f', value: 0. },
    uEyeY: { type: 'f', value: 0. },
    uEyeZ: { type: 'f', value: 1. },
...
const fsh = `
     ...
     uniform float uEyeX;        //x-component of intial rm-eye for rmanim
     uniform float uEyeY;        //y-component of intial rm-eye for rmanim
     uniform float uEyeZ;        //z-component of intial rm-eye for rmanim
     ...
     void main() {
       // eye and fwd
       vec3 eye = vec3(uEyeX,uEyeY,uEyeZ);       // fov=pi/2 => z=1
...
//        uniforms:_uniforms};
export { fsh, uniforms };
//# sourceMappingURL=fsh_rmanim_expt1.glsl.js.map
