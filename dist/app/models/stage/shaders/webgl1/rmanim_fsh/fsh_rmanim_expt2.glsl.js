...
const fsh = `
     ...
     uniform float uEyeX;        //x-component of initial rm-eye
     uniform float uEyeY;        //y-component of initial rm-eye
     uniform float uEyeZ;        //z-component of initial rm-eye
...
vec4 colormarch(vec3 ro, vec3 rd) {
   ...
   return vec4(0.0,0.0,0.0,1.0);
     ...
     void main() {
       ...
       vec3 eye = vec3(uEyeX,uEyeY,uEyeZ);
...
export { fsh, uniforms };
//# sourceMappingURL=fsh_rmanim_expt2.glsl.js.map
