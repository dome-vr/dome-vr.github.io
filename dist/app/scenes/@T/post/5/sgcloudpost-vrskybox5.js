// @test/post/5/sgcloudpost-vrskybox5.ts
// webGL2, es300 three.js ==0.134.0
const config = {
    // rendering topology
    topology: {
        // webxr?
...
const state = {
    ...
    stage: {
        ...
        //NOTE!- cannot use sgskybox since its texture will write over the 
        //sghud-post sghud-renderTarget.texture
        sgscene: {
            _actors: true,
            actors: {
                //                'axes': {
                ...
                'sgcloud': {
                    ...
                    options: {
                        ...
                        urls: ["./app/media/images/glad.png",
                            ...
                            "./app/media/images/pinkLotus.png"],
                        transparent: true,
                        opacity: 1.0,
                        cloudRadius: 2000,
...
//# sourceMappingURL=sgcloudpost-vrskybox5.js.map
