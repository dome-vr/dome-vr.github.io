// app/scenes/@P/cubemaps/4/surreal-daisy-canyon-vrskybox4.js
            ...
            actors: {
                ...
                'vrskybox': {
                    ...
                    options: {
                        ...
                        opacity: 1.0,
                        textures: [
                            './app/media/images/cubemaps/surreal-daisy-canyon/cube_right.png',
                            './app/media/images/cubemaps/surreal-daisy-canyon/cube_left.png',
                            './app/media/images/cubemaps/surreal-daisy-canyon/cube_up.png',
                            './app/media/images/cubemaps/surreal-daisy-canyon/cube_down.png',
                            './app/media/images/cubemaps/surreal-daisy-canyon/cube_back.png',
                            './app/media/images/cubemaps/surreal-daisy-canyon/cube_front.png'
                        ]
