// app/scenes/@P/cubemaps/4/capri3-infrared-pink-vrskybox4.js
            ...
            actors: {
                ...
                'vrskybox': {
                    ...
                    options: {
                        ...
                        opacity: 1.0,
                        textures: [
                            './app/media/images/cubemaps/capri3-infrared-pink/cube_right.png',
                            './app/media/images/cubemaps/capri3-infrared-pink/cube_left.png',
                            './app/media/images/cubemaps/capri3-infrared-pink/cube_up.png',
                            './app/media/images/cubemaps/capri3-infrared-pink/cube_down.png',
                            './app/media/images/cubemaps/capri3-infrared-pink/cube_back.png',
                            './app/media/images/cubemaps/capri3-infrared-pink/cube_front.png'
                        ]
