// app/scenes/@P/cubemaps/4/sakura-Hokusai-vrskybox4.js
            ...
            actors: {
                ...
                'vrskybox': {
                    ...
                    options: {
                        ...
                        opacity: 1.0,
                        textures: [
                            './app/media/images/cubemaps/sakura-Hokusai/cube_right.png',
                            './app/media/images/cubemaps/sakura-Hokusai/cube_left.png',
                            './app/media/images/cubemaps/sakura-Hokusai/cube_up.png',
                            './app/media/images/cubemaps/sakura-Hokusai/cube_down.png',
                            './app/media/images/cubemaps/sakura-Hokusai/cube_back.png',
                            './app/media/images/cubemaps/sakura-Hokusai/cube_front.png'
                        ]
