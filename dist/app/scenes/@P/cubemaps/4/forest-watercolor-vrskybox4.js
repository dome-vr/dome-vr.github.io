// app/scenes/@P/cubemaps/4/forest-watercolor-vrskybox4.js
            ...
            actors: {
                ...
                'vrskybox': {
                    ...
                    options: {
                        ...
                        opacity: 1.0,
                        textures: [
                            './app/media/images/cubemaps/forest-watercolor/cube_right.png',
                            './app/media/images/cubemaps/forest-watercolor/cube_left.png',
                            './app/media/images/cubemaps/forest-watercolor/cube_up.png',
                            './app/media/images/cubemaps/forest-watercolor/cube_down.png',
                            './app/media/images/cubemaps/forest-watercolor/cube_back.png',
                            './app/media/images/cubemaps/forest-watercolor/cube_front.png'
                        ]
