// app/scenes/@P/cubemaps/4/canyon-pink-tree-vrskybox4.js
            ...
            actors: {
                ...
                'vrskybox': {
                    ...
                    options: {
                        ...
                        opacity: 1.0,
                        textures: [
                            './app/media/images/cubemaps/canyon-pink-trees/cube_right.png',
                            './app/media/images/cubemaps/canyon-pink-trees/cube_left.png',
                            './app/media/images/cubemaps/canyon-pink-trees/cube_up.png',
                            './app/media/images/cubemaps/canyon-pink-trees/cube_down.png',
                            './app/media/images/cubemaps/canyon-pink-trees/cube_back.png',
                            './app/media/images/cubemaps/canyon-pink-trees/cube_front.png'
                        ]
