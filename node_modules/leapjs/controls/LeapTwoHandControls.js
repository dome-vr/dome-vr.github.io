...
THREE.LeapTwoHandControls = (function () {
  ...
  var LeapTwoHandControls = function (object, controller, invert) {
    ...
    // rudolph: decreased smootinh coef. ESSENTIAL
    this.translationSpeed = 10; //5.0; //2 //20;
    this.translationDecay = 0.3;
    this.scaleDecay = 0.5;
    this.rotationSlerp = 0.8;
    this.rotationSpeed = 1.0;  //4;
    this.pinchThreshold = 0.5;
    this.transSmoothing = 0.0025; //0.025;  //.05 //0.5
    this.rotationSmoothing = 0.001; //0.01;  //.02 //0.2
